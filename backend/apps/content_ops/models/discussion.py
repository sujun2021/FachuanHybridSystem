...
class DiscussionScript(models.Model):
    ...
    topic = models.TextField(blank=True, verbose_name=_("讨论主题"))
...
class DiscussionTurn(models.Model):
    ...
    speaker_name = models.CharField(max_length=64, verbose_name=_("说话人"))
    speaker_style_prompt = models.TextField(blank=True, verbose_name=_("VoiceDesign 音色描述"))
    text = models.TextField(verbose_name=_("对话内容"))
    order = models.PositiveIntegerField(default=0, verbose_name=_("顺序"))
    created_at = models.DateTimeField(auto_now_add=True, verbose_name=_("创建时间"))
    updated_at = models.DateTimeField(auto_now=True, verbose_name=_("更新时间"))

    class Meta:
        verbose_name = _("对话轮次")
        verbose_name_plural = _("对话轮次")
        ordering = ["order"]
