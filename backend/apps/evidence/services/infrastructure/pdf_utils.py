...
def _read_source_bytes(source: Any) -> Any:  # pragma: no cover
    if source is None:
...
def _read_django_field_file(source: Any) -> Any:  # pragma: no cover
...
def _read_from_path_attr(source: Any) -> Any:  # pragma: no cover
