...
def get_capabilities(request: HttpRequest) -> CapabilityOut:  # pragma: no cover
...
def list_presets(  # pragma: no cover
    request: HttpRequest,
...
def get_preset(request: HttpRequest, preset_id: int) -> PrintPresetSnapshotOut:  # pragma: no cover
    service = get_preset_service()
...
def sync_presets(request: HttpRequest) -> PresetSyncOut:  # pragma: no cover
...
def list_rules(  # pragma: no cover
    request: HttpRequest,
...
def create_rule(request: HttpRequest, payload: PrintKeywordRuleIn) -> PrintKeywordRuleOut:  # pragma: no cover
    service = get_rule_service()
...
def get_rule(request: HttpRequest, rule_id: int) -> PrintKeywordRuleOut:  # pragma: no cover
    service = get_rule_service()
...
def update_rule(request: HttpRequest, rule_id: int, payload: PrintKeywordRuleUpdateIn) -> PrintKeywordRuleOut:  # pragma: no cover
    service = get_rule_service()
...
def delete_rule(request: HttpRequest, rule_id: int) -> dict[str, bool]:  # pragma: no cover
    get_rule_service().delete_rule(rule_id=rule_id)
    return {"success": True}


@router.get("/jobs", response=list[BatchPrintJobSummaryOut])
def list_batch_print_jobs(  # pragma: no cover
    request: HttpRequest,
...
def create_batch_print_job(request: HttpRequest) -> BatchPrintSubmitOut:  # pragma: no cover
...
def get_batch_print_job(request: HttpRequest, job_id: UUID) -> BatchPrintJobOut:  # pragma: no cover
    service = get_batch_print_job_service()
...
def cancel_batch_print_job(request: HttpRequest, job_id: UUID) -> BatchPrintSubmitOut:  # pragma: no cover
    job = get_batch_print_job_service().request_cancel(job_id=job_id)
    return BatchPrintSubmitOut(job_id=str(job.id), status=job.status)


@router.delete("/jobs/{job_id}")
def delete_batch_print_job(request: HttpRequest, job_id: UUID) -> dict[str, bool]:  # pragma: no cover
